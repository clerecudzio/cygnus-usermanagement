			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="url" params="${params}" title="${message(code: 'requestMap.url.label', default: 'Url')}"  />
					
						<g:sortableColumn property="configAttribute" params="${params}" title="${message(code: 'requestMap.configAttribute.label', default: 'Config Attribute')}"  />
